...
namespace SyncfusionBlazorApp1.Controllers
{
	    ...
	    public class StateDataGridController : ControllerBase
        {
         UniversityDbContext db=new UniversityDbContext();

        public StateDataGridController(UniversityDbContext db)
        {
            this.db = db;
        }
       ...
       // POST api/<controller>
        ...
        public Object Post([FromBody]DataManagerRequest dm)
        {
           ...
           return dm.RequiresCounts ?  new { result = DataSource, count = count } : DataSource as object;
				 ...
				 [HttpPost]
        [Route("api/StateDataGrid/Insert")]
        ...
        [HttpPost]
        [Route("api/StateDataGrid/UpdateState")]
        ...
        [HttpPost]
        [Route("api/StateDataGrid/DeleteState")]
