...
namespace SyncfusionBlazorApp1.Controllers
{
	    ...
	    public class Country2DataGridController : ControllerBase
        {
         UniversityDbContext db=new UniversityDbContext();

		public Country2DataGridController(UniversityDbContext db)
		{
			this.db = db;
		}
       ...
       // POST api/<controller>
        ...
        public Object Post([FromBody]DataManagerRequest dm)
        {
           ...
           return dm.RequiresCounts ?  new { result = DataSource, count = count } : DataSource as object;
				 ...
				 [HttpPost]
        [Route("api/Country2DataGrid/Insert")]
        ...
        [HttpPost]
        [Route("api/Country2DataGrid/UpdateCountry")]
        ...
        [HttpPost]
        [Route("api/Country2DataGrid/DeleteCountry")]
